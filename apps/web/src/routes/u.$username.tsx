...
function PublicProfilePage() {
  ...
  const profile = ownerView && user
    ...
    : profileQuery.data;
  const publicTopQuery = useQuery(publicTopListQueryOptions(username, !ownerView && !isSessionLoading && !isSessionError && profile?.lists.topList === 'PUBLIC'));
  const publicSingingQuery = useQuery(publicSingingListQueryOptions(username, !ownerView && !isSessionLoading && !isSessionError && profile?.lists.singingList === 'PUBLIC'));
